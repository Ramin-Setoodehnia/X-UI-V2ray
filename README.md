...
```
bash <(curl -Ls https://raw.githubusercontent.com/amin-Setoodehnia/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/amin-Setoodehnia/3x-ui/master/install.sh) v2.3.6
```
