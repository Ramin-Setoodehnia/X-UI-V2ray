...
[![](https://img.shields.io/github/v/release/Ramin-Setoodehnia/3x-ui.svg)](https://github.com/MHSanaei/3x-ui/releases)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Ramin-Setoodehnia/3x-ui/master/install.sh)
```
...
wget https://github.com/Ramin-Setoodehnia/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/Ramin-Setoodehnia/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/Ramin-Setoodehnia/3x-ui.svg)](https://starchart.cc/MHSanaei/3x-ui)
